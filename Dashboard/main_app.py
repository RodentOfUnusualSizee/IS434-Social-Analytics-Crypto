...
# from network_app import network_layout
...
app.layout = dbc.Container(
    [
        dbc.Row(
            ...
            dbc.Nav(
                [
                    dbc.NavLink("Network", href="http://127.0.0.1:5500/Dashboard/gephi/index.html"),
                    dbc.NavLink("Sentiment", href="#"), #change
                ]
            )
        ),
        ...
        #     dbc.Nav(
        #         [
        #             dbc.NavLink("Network Analysis", href='http://127.0.0.1:5500/Dashboard/gephi/index.html') #href
        #         ]
        #     )
        # )
